        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul class="nav nav-list flex-column primary">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('index')}}"><i class="fas fa-caret-right text-dark"></i> Back</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('logout')}}"><i class="fas fa-caret-right text-dark"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
