...
<html class="fixed">
    ...
    <head>
        <!-- Basic -->
        <meta charset="UTF-8">
        <title>Pusdatin BPAD | Dashboard Monitoring</title>
        <meta name="keywords" content="Pusdatin, BPAD, Dashboard Monitoring" />
        <meta name="description" content="Dashboard Monitoring - Persediaan Aset">
